...
useHead({
  ...
  titleTemplate: (chunk?: string) =>
    chunk ? `${chunk} · City Passport Dublin` : title,
});
...
useHead({
  script: [
    ...
    {
      type: "application/ld+json",
      innerHTML: JSON.stringify(categoryListSchema),
    },
  ],
});
</script>
...
<template>
  ...
  <UApp>
    <UHeader mode="drawer">
      <template #title>
        <img src="/images/logo.png" alt="City Passport Dublin logo" class="w-auto h-10" />
      </template>
      ...
      <template #body>
        ...
        <div class="mr-0">
          <ULink to="/passport-award" icon="i-mdi-seal-variant" exact
            class="group relative flex items-center font-medium text-sm before:absolute before:z-[-1] before:rounded-md focus:outline-none focus-visible:outline-none dark:focus-visible:outline-none focus-visible:before:ring-inset focus-visible:before:ring-2 focus-visible:before:ring-primary px-0 py-1.5 before:inset-x-px before:inset-y-0 transition-colors before:transition-colors"
            active-class="text-highlighted text-primary before:bg-elevated/50"
            inactive-class="text-muted hover:text-highlighted hover:before:bg-elevated/50">
            <UIcon name="i-mdi-seal-variant" class="size-6" />
            Passport Award
          </ULink>
          <ULink to="/artists" icon="i-mdi-palette" exact
            class="group relative flex items-center font-medium text-sm before:absolute before:z-[-1] before:rounded-md focus:outline-none focus-visible:outline-none dark:focus-visible:outline-none focus-visible:before:ring-inset focus-visible:before:ring-2 focus-visible:before:ring-primary px-0 py-1.5 before:inset-x-px before:inset-y-0 transition-colors before:transition-colors"
            active-class="text-highlighted text-primary before:bg-elevated/50"
            inactive-class="text-muted hover:text-highlighted hover:before:bg-elevated/50">
            <UIcon name="i-mdi-palette" class="size-6" />
            Artists
          </ULink>
        </div>
      </template>
      ...
      <template #right>
        <div class="flex gap-1 hidden lg:flex">
          <ULink to="/passport-award" icon="i-mdi-seal-variant" exact
            class="group relative flex items-center gap-1.5 font-medium text-sm before:absolute before:z-[-1] before:rounded-md focus:outline-none focus-visible:outline-none dark:focus-visible:outline-none focus-visible:before:ring-inset focus-visible:before:ring-2 focus-visible:before:ring-primary px-1 py-1.5 before:inset-x-px before:inset-y-0 transition-colors before:transition-colors"
            active-class="text-highlighted text-primary before:bg-elevated/50"
            inactive-class="text-muted hover:text-highlighted hover:before:bg-elevated/50">
            <UIcon name="i-mdi-seal-variant" class="size-6" />
            Passport Award
    ...
    <UMain>
      ...
      <p class="sr-only">
        City Passport Dublin is your curated directory of local restaurants,
        lodging, wellness services, retail shops, professional services, and
        unique experiences in Dublin, Georgia.
      </p>
    ...
    <UFooter class="bg-paper/95 backdrop-blur-sm">
      ...
      <UButton to="mailto:Info@citypassportdublin.com" label="Info@citypassportdublin.com" variant="ghost"
        icon="i-mdi-email" />
