    ...
    <header class="mb-8">
      <h1 class="text-3xl font-bold flex items-center gap-2">
        <UIcon
          ...
          class="h-8 w-8 text-yellow-500 dark:text-yellow-400"
        />
      ...
      >
        ...
        <ol class="list-decimal pl-5 space-y-4 text-sm">
          <li>
            <p>
              <strong>Pick up your passport card</strong> from a participating business. (Marked By <UIcon
                name="i-mdi-decagram"
          ...
          <li>
            ...
            <ul class="list-disc pl-5 mt-2 space-y-1">
              <li>
                Downtown at <NuxtLink
                  to="/business/smiths-jewelry"
                  class="underline hover:no-underline"
                >Smith's Jewelry</NuxtLink>
              </li>
              <li>
                Midtown at <NuxtLink
                  to="/business/emerald-city-treasures"
                  class="underline hover:no-underline"
                >Emerald City Treasures Too</NuxtLink>
              </li>
              <li>
                Interstate at <NuxtLink
                  to="/business/visit-dublin"
                  class="underline hover:no-underline"
                >Visit Dublin</NuxtLink>
              </li>
            </ul>
          </li>
        </ol>
        <p class="mt-4 text-xs opacity-70">
          Support the local businesses you visit.
        </p>
      </UCard>
    </header>

    <div
      v-if="stampGroups.length === 0"
    ...
    >
      ...
      >
        <h2 class="text-2xl font-semibold mb-4 flex items-center gap-2 capitalize">
          <UIcon
            :name="useCategoryIcon(group.category).value"
            class="h-6 w-6"
          />
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1 min-w-0">
                <h3 class="font-medium flex items-center gap-1 text-base">
                  ...
                  <UTooltip
                    text="Passport stamp available"
                    :delay-duration="200"
                  >
                    <UIcon
                      name="i-mdi-decagram"
                      class="text-yellow-500 dark:text-yellow-400 h-4 w-4"
                    />
                  </UTooltip>
                </h3>
                <p
                  v-if="biz.address?.street"
